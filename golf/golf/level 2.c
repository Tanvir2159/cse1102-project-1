...
int main()
{
    ...
    {   
        ...
        // if(fabsf(speed.y)< STOP_THRESHOLD) speed.y = 0;
        ...
        // {
            ...
            if(speed.y<0) speed.y += DECELARATION * (fabsf(speed.y)/Vector2Length(speed)) * dt;
        //}
        // else if(fabsf(speed.y) > fabsf(speed.x))
        // {
        //     if(speed.x>0) speed.x -= DECELARATION * (fabsf(speed.x)/fabsf(speed.y)) * dt;
        //     if(speed.x<0) speed.x += DECELARATION * (fabsf(speed.x)/fabsf(speed.y)) * dt;
        //     if(speed.y>0) speed.y -= DECELARATION * dt;
        //     if(speed.y<0) speed.x += DECELARATION * dt;
        // }
